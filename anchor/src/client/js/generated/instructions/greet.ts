...
import { VESTINGSOL_PROGRAM_ADDRESS } from '../programs';
...
export type GreetInstruction<
  TProgram extends string = typeof VESTINGSOL_PROGRAM_ADDRESS,
...
export function getGreetInstruction<
  TProgramAddress extends Address = typeof VESTINGSOL_PROGRAM_ADDRESS,
>(config?: {
  programAddress?: TProgramAddress;
}): GreetInstruction<TProgramAddress> {
  // Program address.
  const programAddress = config?.programAddress ?? VESTINGSOL_PROGRAM_ADDRESS;
